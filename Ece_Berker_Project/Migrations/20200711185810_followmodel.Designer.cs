...
namespace Ece_Berker_Project.Migrations
{
    ...
    [Migration("20200711185810_followmodel")]
    partial class followmodel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ece_Berker_Project.Models.Answer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ece_Berker_Project.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Ece_Berker_Project.Models.Follow", b =>
                {
            ...
            modelBuilder.Entity("Ece_Berker_Project.Models.YorumluoUser", b =>
                {
            ...
            modelBuilder.Entity("Ece_Berker_Project.Models.Answer", b =>
                {
                    b.HasOne("Ece_Berker_Project.Models.Yorum", "Yorum")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("Ece_Berker_Project.Models.Follow", b =>
                {
                    b.HasOne("Ece_Berker_Project.Models.YorumluoUser", "Follower")
                        .WithMany("Follows")
                        .HasForeignKey("FollowedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ece_Berker_Project.Models.YorumluoUser", "Followed")
                        .WithMany("Followers")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Ece_Berker_Project.Models.YorumluoUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
